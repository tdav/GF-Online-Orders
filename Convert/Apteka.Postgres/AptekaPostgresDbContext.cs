...
{
    public partial class AptekaPostgresDbContext : DbContext
    {
        public AptekaPostgresDbContext()
        {
        }

        public AptekaPostgresDbContext(DbContextOptions<AptekaPostgresDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseNpgsql("Host=localhost;Database=apteka;Username=postgres;Password=2010")
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tbDiscounts>(entity =>
            {
                ...
                entity.Property(e => e.ValidityTo).HasColumnType("timestamp");
            ...
            modelBuilder.Entity<tbDocItems>(entity =>
            {
                ...
                entity.Property(e => e.BookingTimeTo).HasColumnType("timestamp");
            ...
            modelBuilder.Entity<tbOrders>(entity =>
            {
                ...
                entity.Property(e => e.DeliveryTime).HasColumnType("timestamp");
            ...
            modelBuilder.Entity<tbPriceDocs>(entity =>
            {
                ...
                entity.Property(e => e.PriceDate).HasColumnType("timestamp");
            ...
            modelBuilder.Entity<tbSmenas>(entity =>
            {
                ...
                entity.Property(e => e.Begin).HasColumnType("timestamp");

                entity.Property(e => e.CreateDate)
                    .HasColumnType("timestamp")
                    ;

                entity.Property(e => e.End).HasColumnType("timestamp");
            ...
            modelBuilder.Entity<tbTurnovers>(entity =>
            {
                ...
                entity.Property(e => e.CurrentDate).HasColumnType("timestamp");
