...
namespace RssSata.Utils.Serialization
{
    /// <summary>
    ...
    public sealed class SerializationWriter : BinaryWriter
    {
        ...
        private readonly ArrayList objectTokens;
    ...
    public sealed class SerializationReader : BinaryReader
    {
        ...
        private readonly string[] stringTokenList;
        private readonly object[] objectTokens;
